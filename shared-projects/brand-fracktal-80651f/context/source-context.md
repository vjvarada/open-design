...
Canonical design-system title: Fracktal Works is India's Design System

Fracktal Works is India's premier 3D printer manufacturer — an Original Additive Manufacturer based in Bangalore since 2013. We design, engineer, and build every machine in-house from the ground up: no imported kits, no rebadging, pure indigenous engineering. Our product line spans desktop precision (Snowflake), advanced industrial (Julia), dual-extrusion workhorses (Twin Dragon), high-temperature FFF (Volterra), production-grade SLS (Apollo), and the PrintStick bed adhesion system. Beyond hardware we offer FDM, SLS, SLA, MJF, and vacuum casting services from our Bangalore facility, serving automotive, aerospace, medical, dental, and engineering education sectors. The voice is confident, direct, and technical — write like an engineer, not a marketer. Use active voice with short declarative sentences. Own the category: "India's premier 3D printer manufacturer." Emphasize indigenous capability: "built in Bangalore," "in-house," "from the ground up," "OAM," "Make in India." Keep the palette dark and technical — deep navy backgrounds (#0a0a1a), white and cool-gray text, with Fracktal red (#F25E50) as the sole chromatic accent used only for CTAs and key emphasis. Typography is Montserrat 700 for headings, 400 for body. Never use words like "cutting-edge," "revolutionary," "ecosystem," "leveraging," or "seamless." Never describe Fracktal as a startup. Never use AI-generated product imagery — always use real product photography. Every page should pass one test: would an engineer at a world class manufacturing company trust this?

## Source Links

- https://www.fracktal.in

Website/source URLs should be treated as public style and product references when reachable. Record concrete observations before using them as design-system evidence.
...
- Stall Design.pdf
- Wall Graphics Final Revised.pdf
- Fracktal IMTEX Brochures A5 - SLSApollo350.pdf
- Fracktal IMTEX Brochures A5 - Twin Dragon.pdf

Uploaded brand asset files under `assets/`:
- assets/Stall-Design.pdf
- assets/Wall-Graphics-Final-Revised.pdf
- assets/Fracktal-IMTEX-Brochures-A5---SLSApollo350.pdf
- assets/Fracktal-IMTEX-Brochures-A5---Twin-Dragon.pdf
